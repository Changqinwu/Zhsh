...
import com.qiming.wcq.mymapdemo.util.ErrorInfo;
import com.qiming.wcq.mymapdemo.util.TTSController;

import java.util.ArrayList;
import java.util.List;


public class BaseGpsActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
