...
public class LoadWebDataUtil {
    ...
    public LoadWebDataUtil(Context context, com.tencent.smtt.sdk.WebView mWebView, ImageView mImaError, String Url, TextView mTvCount) {
